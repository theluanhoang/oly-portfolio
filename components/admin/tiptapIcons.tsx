...
export function IconColorFill(props: SVGProps<SVGSVGElement>) {
  ...
  const colorFill = typeof (fill as string | undefined) === 'string' ? (fill as string) : '#000';
      ...
      <g fill="none" fillRule="evenodd" stroke="none" strokeWidth={1}>
        <g transform="translate(0.000000, 0.500000)">
          <g transform="translate(39.000000, 17.353553)">
            {/* Đường line dưới cùng - đổi màu theo fill */}
            <path
              ...
              fillRule="evenodd"
            />
            {/* Hình tam giác/chữ A - giữ màu currentColor */}
            <path
              ...
              fillRule="nonzero"
            />
            {/* Đường line ngang trong chữ A - giữ màu currentColor */}
            <path
